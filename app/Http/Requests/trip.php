...
class trip extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'start_trip.required' => 'وقت انطلاق الرحلة مطلوب',
            'start_trip.date_format' => 'وقت انطلاق الرحلة يجب ان يكون من النمط ساعة:دقيقة',
            'end_trip.required' => 'وقت وصول الرحلة مطلوب',
            'end_trip.date_format' => 'وقت وصول الرحلة يجب ان يكون من النمط ساعة:دقيقة',
