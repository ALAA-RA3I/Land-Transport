...
@section('content')
    <div class="container" >
        ...
        @endif
        <table id="TodayTripsTable" class="table table-striped nowrap" style="width:500px ;font-size:medium  ">
            <thead>
            <tr>
                <th>ID</th>
                <th>رقم الرحلة</th>
